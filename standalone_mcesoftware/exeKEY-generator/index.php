...
<body>
    ...
    <div id="github">
        ...
        <div id="file_link">
            <p style="margin:0px; font-size: 12px;">Download the Latest Version – Click to Access on Google Drive <a style="color: #000; font-size: 13px;" href="https://drive.google.com/drive/folders/13CnBJUgp80Ogv_Atc-atTBsERYga-A_h?usp=sharing" class="download-button">&#x1F4C1; magnetocaloric.exe</a></p>
